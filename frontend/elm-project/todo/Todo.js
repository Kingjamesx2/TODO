...
var $author$project$Todo$Model = F2(
	function (name, task) {
		return {name: name, task: task};
	});
var $author$project$Todo$init = A2($author$project$Todo$Model, '', '');
...
var $author$project$Todo$viewValidation = function (model) {
	return ((model.name === '') || (model.task === '')) ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$action('http://localhost:4000/v1/todoInfo'),
							...
							[
								...
								_List_fromArray(
									[
										...
										A4($author$project$Todo$viewInput, 'text', 'Task', model.task, $author$project$Todo$Task),
